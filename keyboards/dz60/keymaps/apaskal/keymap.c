...
// pc layout
	KEYMAP(
		...
		KC_NO,   KC_LGUI, KC_LALT, MO(2), KC_SPC, MO(2), KC_RALT, KC_RCTL , KC_NO, LT(3,KC_INS), KC_NO),
...
// mac os layout
	KEYMAP(
		...
		F(0),    KC_A, KC_S, KC_D, KC_F, KC_G, KC_H, KC_J, KC_K, KC_L, KC_SCLN, KC_QUOT, F(1), 
		KC_LSFT, KC_NO, KC_Z, KC_X, KC_C, KC_V, KC_B, KC_N, KC_M, KC_COMM, KC_DOT, KC_SLSH, KC_RSFT, KC_DEL, 
		KC_NO,   KC_LALT, KC_LGUI, MO(2), KC_SPC, MO(2), KC_RALT, KC_RCTL , KC_NO, LT(3,KC_INS), KC_NO),

// navigation and keypad layout
	KEYMAP(
		...
		KC_CAPS, KC_NO,   KC_PDOT, KC_P1,   KC_P2,   KC_P3,   KC_PPLS, KC_NLCK, KC_PGDN, KC_TRNS, KC_TRNS, S(KC_GRV), KC_TRNS, KC_TRNS, 
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),

// rgb and misc layout
	KEYMAP(
		KC_GRV,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11,  KC_F12, KC_TRNS, KC_DEL, 
		KC_TRNS, RGB_TOG, RGB_MOD, RGB_HUI, RGB_HUD, RGB_SAI, RGB_SAD, RGB_VAI, RGB_VAD, KC_TRNS, TO(0), KC_TRNS, KC_TRNS, RESET, 
		KC_TRNS, KC_TRNS, RGB_M_P, KC_TRNS, KC_TRNS, RGB_M_G, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 
		KC_TRNS, KC_TRNS, KC_TRNS, RGB_M_X, BL_DEC,  BL_TOGG, BL_INC,  BL_STEP, TO(1),   KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 
		KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS),
