...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
	...
	KEYMAP(
		...
		KC_NO, KC_LGUI, KC_LALT, MO(1), KC_SPC, MO(1), KC_RALT, KC_CAPS , MO(2), KC_NO, KC_NO),

	KEYMAP(
		KC_INS,  KC_F1,   KC_F2,   KC_F3,   KC_F4,   KC_F5,   KC_F6,   KC_F7,   KC_F8,   KC_F9,   KC_F10,  KC_F11, KC_F12, KC_TRNS, KC_DEL, 
		KC_BSPC, KC_PSLS, KC_P7,   KC_P8,   KC_P9,   KC_PAST, KC_PSCR, KC_PGUP, KC_UP,   KC_O,    KC_P, KC_GRV, KC_TRNS, RESET, 
		F(0),    KC_P0,   KC_P4,   KC_P5,   KC_P6,   KC_PMNS, KC_HOME, KC_LEFT, KC_DOWN, KC_RGHT, KC_END, KC_TRNS, KC_TRNS, 
		KC_LSFT, KC_NO,   KC_PDOT, KC_P1,   KC_P2,   KC_P3,   KC_PPLS, KC_NLCK, KC_PGDN, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, KC_TRNS, 
	...
	KEYMAP(
		KC_TRNS, M(1), M(2), M(3), KC_Z, M(5), M(6), M(7), M(8), M(9), M(10), M(11), M(12), KC_TRNS, KC_TRNS, 
